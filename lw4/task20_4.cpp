...
//void MaxPath(std::shared_ptr<Node>& node, int& currentTime, int& maxTime)
//{
...
//        MaxPath(child, currentTime, maxTime);
//
//        currentTime -= child->time;
//    }
//}
